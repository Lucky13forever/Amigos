...
class User():
    ...
    def create_new_user(name, email, password, county, city, phone, avg_consumption, surface):
        ...
        # append the new_user
        with open(r"D:\demo_nou_git\AMIGOS\website\database\tabel_users.json", 'r') as file:
            ...
            with open(r"D:\demo_nou_git\AMIGOS\website\database\tabel_users.json", 'w') as file:
